      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-4 pr-8">
            <h1 className="text-2xl font-black text-coffee tracking-tighter mb-6 uppercase">
              {siteName}<span className="text-gold-accent">.COM</span>
            </h1>
            <p className="text-coffee font-medium leading-relaxed text-sm max-w-sm">
              {footerText}
            </p>
          </div>
          ...
          <div className="lg:col-span-2">
            <h1 className="font-black text-xs text-coffee uppercase tracking-widest mb-8">
              Explore
            </h1>
            <ul className="space-y-4">
              {categories.length > 0 ? (
                categories.map((cat) => (
                  <li key={cat.id}>
                    <Link 
                      ...
                      className="text-sm font-bold text-coffee hover:text-gold-accent transition-colors flex items-center gap-1 group"
                    >
                      {cat.name}
                    </Link>
                  </li>
                ...
                <li className="text-sm text-zinc-600 italic">Belum ada kategori</li>
              )}
            </ul>
          </div>
              ...
              {SOCIAL_LINKS.map((social, idx) => {
                ...
                return (
                  <a 
                    ...
                    className="group flex items-center gap-4 text-coffee hover:text-gold-accent transition-colors w-fit"
                  >
          ...
          <div className="lg:col-span-3">
            <div className="bg-white p-6 rounded-2xl border border-coffee/5 shadow-sm">
              <h1 className="font-black text-xs text-coffee uppercase tracking-widest mb-4">
                Affiliate Disclosure
              </h1>
              <p className="text-[11px] text-coffee leading-relaxed font-medium">
        ...
        <div className="border-t border-coffee/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="text-[10px] font-bold text-coffee uppercase tracking-wider hover:text-gold-accent">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-[10px] font-bold text-coffee uppercase tracking-wider hover:text-gold-accent">
              Terms of Service
            </Link>
          </div>
